...
export function ExportingProfile({ match }) {
  ...
  useEffect(() => {
    ...
    Axios.post(
      "http://localhost:3001/api/myallpost",
      data
    ).then((result) => {
      //  console.log(result);
    ...
    Axios.post(
      "http://localhost:3001/api/checkfollow",
      dataa
    )
      .then((result) => {
        // console.log(result);
    ...
    Axios.post("http://localhost:3001/api/userfollower", {
      id: id,
    })
      .then((result) => {
        //  console.log(result);
    ...
    Axios.post("http://localhost:3001/api/userfollowing", {
      id: id,
    })
      .then((result) => {
        //  console.log(result);
    ...
    Axios.post(
      "http://localhost:3001/api/detailUserFollower",
      { _id: id }
    ).then((result) => {
      //  console.log(result);
    ...
    Axios.post(
      "http://localhost:3001/api/findallmessages",
      { id: id }
    )
      .then((result) => {
        //  console.log(result.data);
